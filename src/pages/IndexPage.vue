        ...
        <q-card-section class="q-pa-none">
          <div class="weather-content">
            ...
            <div class="weather-info">
              ...
              <div class="text-overline"><strong>Current Weather Temperature</strong></div>
            </div>
          </div>
        </q-card-section>
        ...
        <q-card-section class="q-pa-none">
            <div class="temp-info">
              <q-list bordered separator>
                <q-separator spaced />
                <q-card-section><q-item-label header class="row justify-center"><strong>Humidity</strong></q-item-label></q-card-section>
                ...
                <q-item v-for="(record, index) in temperatureData" :key="index" v-ripple>
                  ...
                  <q-item-section side top>
                    ...
                    <q-item-label caption>Date: {{record.createdat}}</q-item-label>
      ...
      <q-card flat  class="temp-card q-ml-md">
        <q-card-section class="q-pa-none">
            <div class="temp-info">
              <q-list bordered separator>
                <q-separator spaced />
                <q-card-section><q-item-label header class="row justify-center"><strong>Temperature</strong></q-item-label></q-card-section>

                <q-item v-for="(record, index) in temperatureData" :key="index" v-ripple>

                  <q-item-section>
                    <!-- <q-item-label class="text-primary">Humidity: {{ record.humidity }}</q-item-label> -->
                    <q-item-label class="text-red"> Temp: {{ record.temperature }}°C</q-item-label>
                  </q-item-section>
...
export default defineComponent({
  ...
  setup() {
    ...
    const fetchTemperatureData = async () => {
      try {
        const response = await axios.get('http://localhost:4444/temperature');
